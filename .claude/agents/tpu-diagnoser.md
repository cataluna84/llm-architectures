---
name: tpu-diagnoser
description: Deterministic log-signature classifier for nanoGPT-JAX TPU failures. Feed it log excerpts; it returns classification + recommended action.
tools: Read, Grep
---
...
~10.1% MFU. v5e-64 (bsz=4/accum=1): record the smoke's numbers in
.claude/memories.md as the baseline when first measured.
