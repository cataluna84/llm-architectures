...
NANOGPT_MUON_MOMENTUM_MIN="${NANOGPT_MUON_MOMENTUM_MIN:-}"
NANOGPT_MUON_MOMENTUM_MAX="${NANOGPT_MUON_MOMENTUM_MAX:-}"
NANOGPT_GRAD_CLIP_NORM="${NANOGPT_GRAD_CLIP_NORM:-}"
NANOGPT_MIN_LR="${NANOGPT_MIN_LR:-}"
NANOGPT_NS_STEPS="${NANOGPT_NS_STEPS:-}"
NANOGPT_MU_DTYPE="${NANOGPT_MU_DTYPE:-}"
NANOGPT_LR_SCHEDULE="${NANOGPT_LR_SCHEDULE:-}"
NANOGPT_WSD_WARMDOWN_FRAC="${NANOGPT_WSD_WARMDOWN_FRAC:-}"
NANOGPT_DIVERGENCE_ABORT="${NANOGPT_DIVERGENCE_ABORT:-}"
# W&B grouping (read natively by the wandb library) so the report generator
# can query one group instead of pattern-matching run names.
...
[ -n "$WANDB_RUN_GROUP" ] && WANDB_ENV_LINES+="export WANDB_RUN_GROUP=\"$WANDB_RUN_GROUP\""$'\n'
[ -n "$WANDB_JOB_TYPE" ] && WANDB_ENV_LINES+="export WANDB_JOB_TYPE=\"$WANDB_JOB_TYPE\""$'\n'
...
export NANOGPT_MUON_MOMENTUM_MIN="$NANOGPT_MUON_MOMENTUM_MIN"
export NANOGPT_MUON_MOMENTUM_MAX="$NANOGPT_MUON_MOMENTUM_MAX"
export NANOGPT_GRAD_CLIP_NORM="$NANOGPT_GRAD_CLIP_NORM"
export NANOGPT_MIN_LR="$NANOGPT_MIN_LR"
export NANOGPT_NS_STEPS="$NANOGPT_NS_STEPS"
export NANOGPT_MU_DTYPE="$NANOGPT_MU_DTYPE"
export NANOGPT_LR_SCHEDULE="$NANOGPT_LR_SCHEDULE"
export NANOGPT_WSD_WARMDOWN_FRAC="$NANOGPT_WSD_WARMDOWN_FRAC"
export NANOGPT_DIVERGENCE_ABORT="$NANOGPT_DIVERGENCE_ABORT"
